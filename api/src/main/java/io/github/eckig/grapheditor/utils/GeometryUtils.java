...
public class GeometryUtils {
 ...
 /**
   ...
   *
   * <p>
   * This is for example useful for a 1-pixel-wide stroke with a stroke-type of centered. The x and y positions need to
   * be off-pixel so that the stroke is on-pixel.
   * </p>
   *
   * @param position
