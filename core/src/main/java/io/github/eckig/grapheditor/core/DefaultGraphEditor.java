...
public class DefaultGraphEditor implements GraphEditor {
  ...
  private final com.ergotech.grapheditor.core.GraphEditorController<DefaultGraphEditor> mController;
  ...
  public DefaultGraphEditor(final GraphEditorProperties pProperties) {
    ...
    mController = new com.ergotech.grapheditor.core.GraphEditorController<>(this, mSkinManager, mView,
        mConnectionEventManager, mProperties);
  ...
  public void reload() {
    // ???? mController.process();
    //throw new RuntimeException("What's required in this method");
  }
